...
set output 'topscripts-data.png'
set title "Noto Scripts with Largest # of Open Issues" font ",20"
set key left box
set term png
...
plot 'googlefonts.noto-fonts.topscripts-data.csv' using 2:xtic(1),\
